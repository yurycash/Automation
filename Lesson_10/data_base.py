...
class DbEmployee:
    ...
    def get_list_employee(self, company_id):
        list_employee = self.__db.execute(
            self.scripts['list_employee'], company_id=company_id)
    ...
    def add_new_employee(self, first_name, last_name, phone, is_active, company_id):
        self.__db.execute(self.scripts['new_employee'], first_name=first_name,
                          last_name=last_name, phone=phone, is_active=is_active, company_id=company_id)

    def edit_employee(self, first_name, last_name, phone, is_active, company_id, id):
        self.__db.execute(self.scripts['edit'], first_name=first_name, last_name=last_name,
                          phone=phone, is_active=is_active, company_id=company_id, id=id)
